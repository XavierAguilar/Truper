...
// 3. Inject HTML UI
let htmlSearch = `<div class="bktpl-preview-canvas" id="bktplCanvasWrapper">
                    <div id="bktplLiveCanvas"></div>
                </div>`;
let htmlInject = htmlSearch + `
...
html = html.replace(htmlSearch, htmlInject);
...
console.log("Safe string-based replacement successful. toggleBackTagsView is intact.");
